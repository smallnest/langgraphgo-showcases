...
基于 [LangGraphGo](https://github.com/smallnest/langgraphgo) 构建的 AI 驱动知识管理应用程序，让您从文档中创建智能笔记本。
...
```bash
# 进入 showcase 目录
cd langgraphgo/showcases/open-notebook
...
- 在 [GitHub](https://github.com/smallnest/langgraphgo/issues) 上报告问题
- 加入 [LangGraphGo 社区](https://github.com/smallnest/langgraphgo/discussions) 讨论
...
使用 [LangGraphGo](https://github.com/smallnest/langgraphgo) 用 ❤️ 制作
